  ...
  <body>
    ...
    <div class="head">
     ...
     <main class="container-fluid">
	    <div class="row">
		   <div class="col-md-10">
		      <s:form action="book/book_editBook" cssClass="form-horizontal" method="post" enctype="multipart/form-data">
		       ...
		       <div class="panel panel-success">
		           ...
		           <div class="panel-body">
				       <div class="form-group">
			                ...
			                <div class="col-md-2">
                              <input type="text" name="book.bookname" value="<s:property value='book.bookname'/>" class="form-control input-sm" required>
                           </div>
			           </div>  
			           <div class="form-group">
			                <label class="control-label col-md-3">书籍类型</label>
			                <div class="col-md-2">
                              <input type="text" name="book.booktype" value="<s:property value='book.booktype'/>" class="form-control input-sm" placeholder="&yen;" required>
                            </div>
			           </div>
			           <div class="form-group">
			                <label class="control-label col-md-3">书籍作者</label>
			                <div class="col-md-2">
                              <input type="text" name="book.author" value="<s:property value='book.author'/>" class="form-control input-sm" placeholder="&yen;" required>
                            </div>
			           </div>
			           <div class="form-group">
			                <label class="control-label col-md-3">书籍单价</label>
			                <div class="col-md-2">
                              <input type="text" name="book.unitprice" value="<s:property value='book.unitprice'/>" class="form-control input-sm" placeholder="&yen;" required>
                            </div>
			           </div>
			            <div class="form-group">
			                <label class="control-label col-md-3">书籍文案</label>
			                <div class="col-md-2">
                              <input type="text" name="book.bookwenan" value="<s:property value='book.bookwenan'/>" class="form-control input-sm" placeholder="&yen;" required>
                            </div>
			           </div>
			           <div class="form-group">
			                ...
			                <div class="col-md-4">
                              <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                   <img src="<%=basePath%><s:property value='book.picture'/>" alt="" />
                                </div>
